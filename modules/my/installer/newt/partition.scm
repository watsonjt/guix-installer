...
(define-module (my installer newt partition)
  #:use-module (my installer parted)
  ...
  #:use-module (newt)
  #:use-module (parted)
  #:export (run-my-partitioning-page))
...
(define (run-my-partitioning-page)
  "Run a page asking the user for a partitioning method."
  (define (run-page devices)
    (let* ((items
            `((entire . ,(G_ "Guided - using the entire disk Hello"))
