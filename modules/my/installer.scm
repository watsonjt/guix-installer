...
(define (my-installer-program)
  ...
  (define modules
    (append
      (scheme-modules* (string-append (getcwd) "/..") "my")
      (scheme-modules*
    ...
    (with-extensions (list guile-gcrypt guile-newt
      ...
      (with-imported-modules `(,@(source-module-closure
                                  `(,@modules
                                    (gnu services herd)
                                    (guix build utils))
				  (cons "/home/jon/guix-installer/modules" %load-path)
	  ...
	  (use-modules (gnu installer record)
            ...
            (let* ((current-installer my-newt-installer)
